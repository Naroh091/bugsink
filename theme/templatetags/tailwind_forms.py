...
def tailwind_formfield(formfield, implicit=False):
    ...
    formfield.field.widget.attrs['class'] += (
        " border border-slate-300 dark:border-slate-600 rounded-md pl-3 py-1.5 text-sm"
        " focus:outline-none focus:border-cyan-500 dark:focus:border-cyan-400"
        " focus:ring-1 focus:ring-cyan-200 dark:focus:ring-cyan-700 w-full"
    )
